...
const products: Product[] = [
	{
		...
		description:
			"Controle eficiente de microrganismos nos processos industriais."
	},
	{
...
export function SolucoesQuimicas() {
	...
	const activeColor =
		segments.find(s => s.id === activeSegment)?.color ?? "#0f3316";
				...
				{filtered.map((product, index) => (
					...
					>
						...
						<div className="p-5">
							...
							<p className="mt-1.5 text-xs leading-relaxed text-[#5a6478]">
								{product.description}
							</p>
							...
							<div className="mt-4 flex items-center justify-between">
								<span
									...
									style={{
										background: `linear-gradient(90deg, ${activeColor}, #8bc53f)`
									}}
								/>
								<Link
									to="/contato"
