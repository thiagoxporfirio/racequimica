  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ background: 'linear-gradient(90deg, transparent 0%, #8bc53f 30%, #bedd8c 60%, transparent 100%)' }}
        aria-hidden="true"
      />
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `group flex items-center gap-2 text-sm transition-all duration-200 ${
                      isActive ? 'text-[#bedd8c]' : 'text-slate-300/80 hover:text-slate-100'
                    }`
                  }
                >
                  <span className="inline-block h-px w-4 bg-current opacity-40 transition-all duration-200 group-hover:w-6 group-hover:opacity-80" aria-hidden="true" />
                  {item.label}
                </NavLink>
              </li>
            ))}
            <li>
              <a href="#" className="group flex items-center gap-2 text-sm text-slate-300/80 transition-all duration-200 hover:text-slate-100">
                <span className="inline-block h-px w-4 bg-current opacity-40 transition-all duration-200 group-hover:w-6 group-hover:opacity-80" aria-hidden="true" />
        ...
        >
          ...
          <div className="space-y-2.5 text-sm">
            <p className="flex items-center gap-2 text-slate-200">
              <svg className="h-4 w-4 shrink-0 text-[#8bc53f]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
            ...
            <p className="flex items-start gap-2 text-slate-300/75 leading-relaxed">
              <svg className="mt-0.5 h-4 w-4 shrink-0 text-[#8bc53f]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
      ...
      <div className="relative border-t border-white/8">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <p className="text-xs text-slate-400/60">
            © {new Date().getFullYear()} Race Química. Todos os direitos reservados.
          </p>
