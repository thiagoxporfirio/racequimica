    ...
    <div className="space-y-16">
      <section className="rq-fade-up relative min-h-[520px] overflow-hidden rounded-[28px] bg-[#071c0b] text-white shadow-[0_18px_50px_rgba(7,28,11,0.3)]">
        ...
        <div className="relative flex min-h-[520px] flex-col justify-end px-6 py-10 sm:px-10 lg:px-14">
          <div className="mb-10 flex items-center justify-between gap-6">
            ...
            <span className="hidden h-px flex-1 bg-[#8bc53f] sm:block" aria-hidden="true" />
          </div>
      ...
      <section className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="rq-fade-up space-y-4">
          <p className="text-[11px] font-bold uppercase tracking-[0.28em] text-[#8bc53f]">Nossa historia</p>
        ...
        <div className="space-y-4">
          {timeline.map((item, index) => (
            ...
            >
              <p className="font-['Outfit',sans-serif] text-xl font-semibold text-[#0f3316]">{item.year}</p>
              <div>
                <h3 className="font-['Outfit',sans-serif] text-lg font-semibold text-[#1a4db8]">{item.title}</h3>
      ...
      <section className="space-y-7">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[0.28em] text-[#8bc53f]">Principios</p>
            <h2 className="mt-1 font-['Outfit',sans-serif] text-3xl font-semibold text-[#0f3316]">
              Missao, visao e valores
            </h2>
          </div>
          <span className="hidden h-px flex-1 bg-[#8bc53f]/45 sm:block" aria-hidden="true" />
        </div>
      ...
      <section className="relative overflow-hidden rounded-[28px] bg-[#071c0b] text-white shadow-[0_16px_45px_rgba(7,28,11,0.28)]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#071c0b] via-[#071c0b]/95 to-[#071c0b]/72" aria-hidden="true" />
...
function PillarCard({
  ...
  return (
    <article className={`rq-fade-up rq-d${delay} bg-white p-7 shadow-sm ring-1 ring-[#d1d8e3]`}>
      ...
      <h3 className="font-['Outfit',sans-serif] text-2xl font-semibold text-[#0f3316]">{title}</h3>
...
function QualityItem({ children }: { children: ReactNode }) {
  return (
    <li className="flex items-start gap-3">
      <span className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#8bc53f]" aria-hidden="true" />
      <span>{children}</span>
    </li>
  );
}
