      ...
      <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <article className="rq-scale-in space-y-5 rounded-3xl border border-[#c2ccda]/70 bg-white p-7 shadow-sm">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #f5f8fc 0%, #edf2f8 100%)' }}
          >
            <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.2em] text-[#4d5e78]">Horários</p>
        ...
        >
          ...
          <FormField label="Nome completo" type="text" placeholder="Seu nome" autoComplete="name" />
          <FormField label="Email" type="email" placeholder="voce@empresa.com" autoComplete="email" />
          <FormField label="Telefone" type="tel" placeholder="(16) 0000-0000" autoComplete="tel" />
