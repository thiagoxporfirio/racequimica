...
const videos = [
  ...
  },
  {
    ...
    description: 'Demonstração do polímero catiônico RC CAT aplicado em campo com resultados técnicos comprovados.',
    tag: 'Demonstração',
  },
];
    ...
    <div className="space-y-16">
      ...
      <section className="rq-scale-in rq-d200 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
        <article
          ...
          style={{
            background: 'linear-gradient(135deg, #071c0b 0%, #0f3316 60%, #1a4a1e 100%)',
            boxShadow: '0 6px 32px rgba(7,28,11,0.32), inset 0 1px 0 rgba(255,255,255,0.07)',
          }}
        >
          {/* Decorative blobs */}
          <div
          ...
          {videos.map((video, i) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="mt-1 text-sm leading-relaxed text-[#c8e0c0]">{video.description}</p>
              </div>
            </article>
          ))}
        </div>
